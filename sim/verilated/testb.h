...
// DO NOT EDIT THIS FILE!
//
// CmdLine:	autofpga autofpga -d -o . clock50.txt global.txt version.txt buserr.txt pic.txt pwrcount.txt gpio.txt sdramdev.txt bkram.txt hbconsole.txt zipbones.txt mem_flash_bkram.txt mem_bkram_only.txt mem_flash_sram.txt mem_sdram_only.txt
//
...
public:
	...
	virtual	void	tick(void) {
		...
		// trace.
		eval();
		if (m_trace && !m_paused_trace) m_trace->dump(m_time_ps+17);
