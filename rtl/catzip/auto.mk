...
## DO NOT EDIT THIS FILE!
##
## CmdLine:	autofpga autofpga -d -o . global.txt bkram.txt buserr.txt clockpll40.txt pic.txt pwrcount.txt version.txt hbconsole.txt gpio.txt zipbones.txt sdramdev.txt mem_sdram_bkram.txt
##
...
VFLIST := main.v  $(SDRAM) $(ZIPCPU) $(GPIO) $(HBBUS) $(PPORT) $(BKRAM) $(BUSPIC)
