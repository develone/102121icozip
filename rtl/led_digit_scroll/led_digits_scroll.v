...
always @(disp_drvr_enbls[0], disp_digit_shf[0]) begin: LED_DIGITS_SCROLL_DISP_INST_0_DRVR_LOGIC
...
always @(disp_drvr_enbls[1], disp_digit_shf[1]) begin: LED_DIGITS_SCROLL_DISP_INST_1_DRVR_LOGIC
...
always @(disp_drvr_enbls[2], disp_digit_shf[2]) begin: LED_DIGITS_SCROLL_DISP_INST_2_DRVR_LOGIC
...
always @(disp_drvr_enbls[3], disp_digit_shf[3]) begin: LED_DIGITS_SCROLL_DISP_INST_3_DRVR_LOGIC
...
always @(disp_drvr_enbls[4], disp_digit_shf[4]) begin: LED_DIGITS_SCROLL_DISP_INST_4_DRVR_LOGIC
...
always @(disp_drvr_enbls[5], disp_digit_shf[5]) begin: LED_DIGITS_SCROLL_DISP_INST_5_DRVR_LOGIC
...
always @(disp_drvr_enbls[6], disp_digit_shf[6]) begin: LED_DIGITS_SCROLL_DISP_INST_6_DRVR_LOGIC
...
always @(disp_drvr_enbls[7], disp_digit_shf[7]) begin: LED_DIGITS_SCROLL_DISP_INST_7_DRVR_LOGIC
...
always @(charstring[40-1:32], charstring[64-1:56], disp_digit_all_i, disp_digit_shf, charstring[16-1:8], charstring[32-1:24], charstring[24-1:16], charstring[8-1:0], charstring[56-1:48], charstring[48-1:40]) begin: LED_DIGITS_SCROLL_DISP_GET_ACTIVE_DIGIT
...
always @(disp_active_segments, disp_digit_shf, disp_blank) begin: LED_DIGITS_SCROLL_DISP_COMBINE_DRIVERS
